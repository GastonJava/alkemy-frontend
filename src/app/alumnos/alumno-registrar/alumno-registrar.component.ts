...
export class AlumnoRegistrarComponent implements OnInit {
  ...
  constructor(private srvlistamateria: TodoserviceService) {}
  ...
  obtenerDatos(data) {
    ...
    this.srvlistamateria.listaMateriasConfirmada().subscribe((response) => {
      ...
      if (this.nombreMateriaConfirmadatotal.includes(this.nombreMateriaSeleccionado))
      {
              ...
              if(result.value){
                ...
                Swal.fire(
                  ...
                  */                 
                 {
                  ...
                  title:
                      `<span style="color:#75BAFF">Se cancelo solicitud para rendir! <p style="color:red; text-decoration:line-through"> ${data.nombre}</p></span>`,
                      timer: 2000,
                      icon: "success",
                      showConfirmButton: false,
                      confirmButtonText: "Genial",
