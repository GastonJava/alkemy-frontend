...
const routes = [
    { path: 'principalform', loadChildren: () => Promise.all(/*! import() | modules-formulario-formulario-module */[__webpack_require__.e("default~alumno-consultar-alumno-consultar-module~alumno-registrar-alumno-registrar-module~modules-fo~41eedd00"), __webpack_require__.e("default~alumno-consultar-alumno-consultar-module~alumno-registrar-alumno-registrar-module~modules-fo~65087715"), __webpack_require__.e("modules-formulario-formulario-module")]).then(__webpack_require__.bind(null, /*! ./modules/formulario/formulario.module */ "./src/app/modules/formulario/formulario.module.ts")).then(m => m.FormularioModule), pathMatch: 'full' },
    { path: '', redirectTo: 'principalform', pathMatch: 'full' },
    { path: 'adminprincipal', loadChildren: () => __webpack_require__.e(/*! import() | modules-admin-admin-module */ "modules-admin-admin-module").then(__webpack_require__.bind(null, /*! ./modules/admin/admin.module */ "./src/app/modules/admin/admin.module.ts")).then(m => m.AdminModule), canActivate: [_modules_formulario_services_AuthGuard_service__WEBPACK_IMPORTED_MODULE_4__["AuthGuardService"]], data: { RolesPermitidos: ['Administrador'] } },
    { path: 'alumnoprincipal', loadChildren: () => __webpack_require__.e(/*! import() | modules-alumnos-alumnos-module */ "modules-alumnos-alumnos-module").then(__webpack_require__.bind(null, /*! ./modules/alumnos/alumnos.module */ "./src/app/modules/alumnos/alumnos.module.ts")).then(m => m.AlumnosModule), canActivate: [_modules_formulario_services_AuthGuard_service__WEBPACK_IMPORTED_MODULE_4__["AuthGuardService"]], data: { RolesPermitidos: ['Alumno'] } }
];
...
let FooterComponent = class FooterComponent {
    constructor(http, srvboolean, router, srvlogout, srvtestauthorize) {
        this.http = http;
        this.srvboolean = srvboolean;
        this.router = router;
...
let AuthGuardService = class AuthGuardService {
    constructor(route, jwtHelper, authservice) {
        this.route = route;
    ...
    canActivate(next) {
        ...
        if (token && !this.jwtHelper.isTokenExpired(token)) {
            ...
            let roles = next.data['RolesPermitidos'];
...
let Api_alkemyService = class Api_alkemyService {
    ...
    rolesCoinciden(rolesPermitidos) {
        var isMatch = false;
...
Api_alkemyService.ctorParameters = () => [
...
TodoserviceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
...
let UrlbooleanService = class UrlbooleanService {
    constructor() {
