...
var FormularioComponent = /** @class */ (function () {
    function FormularioComponent(fb, srv, srvauthservice, router, http, helper) {
        this.fb = fb;
        this.srv = srv;
    ...
    FormularioComponent.prototype.FormDataGroup = function () {
    ...
    Object.defineProperty(FormularioComponent.prototype, "Email", {
        get: function () {
    ...
    Object.defineProperty(FormularioComponent.prototype, "Pass", {
        get: function () {
    ...
    Object.defineProperty(FormularioComponent.prototype, "rolNombre", {
        get: function () {
    ...
    FormularioComponent.prototype.login = function () {
        var _this = this;
        this.srv.loguearusuario(this.inputs.value).subscribe(function (response) {
            /*  this.onSuccessMessage = true; */
            _this.onErrorMessage = false;
            ...
            if (user) {
                localStorage.setItem("jwt", user);
                if (_this.rolNombre.value == "Administrador") {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
                        title: "<span style=\"color:#75BAFF\">Bienvenido: " + _this.Email.value + " <p style = \"color:green;\">Logueado con exito</p> </span>",
                        text: "Redirigiendo...",
                        showClass: {
                    ...
                    setTimeout(function () {
                        _this.router.navigate(["/adminprincipal"]);
                    }, 5000);
                }
                else if (_this.rolNombre.value == "Alumno") {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire({
                        title: "<span style=\"color:#75BAFF\">Bienvenido: Alumno: " + _this.Email.value + " <p style = \"color:green;\">Logueado con exito</p> </span>",
                        text: "Redirigiendo...",
                        showClass: {
                            popup: "animate__animated animate__fadeInDown",
                        },
                    ...
                    setTimeout(function () {
                        _this.router.navigate(["/alumnoprincipal"]);
            ...
            if (_this.srvauthservice.esUsuarioAutenticado) {
            }
            //error al loguearse contraseña o email incorrecto
            _this.onErrorMessage = true;
            /* console.log(err) */
        });
    };
...
var FormularioRoutingModule = /** @class */ (function () {
    function FormularioRoutingModule() {
    }
    ...
    return FormularioRoutingModule;
}());
...
var FormularioModule = /** @class */ (function () {
    function FormularioModule() {
    }
...
//# sourceMappingURL=modules-formulario-formulario-module-es5.js.map